            ...
            @endif
                ...
                <div class="overflow-x-auto">
                    <div class=" mx-auto p-6 bg-white rounded-lg shadow-md">
                        <h2 class="text-2xl font-bold mb-6 text-gray-800" style="text-align: center;margin-top: 30px;">Add/Update Privacy Policies</h2>
                        <form action="{{route('privacypolicystore')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <label for="content" class="block text-gray-700 text-sm font-bold mb-2" style="text-align: center;margin-bottom: 20px;">Privacy Policy Content</label>
                            </div>
